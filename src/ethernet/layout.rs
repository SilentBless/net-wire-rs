...
wire_repr::wire_repr! {
    ...
    pub layout EthernetFrame {
        ...
        field destination: bytes(6) as super::address::MacAddress;
        /// The source Ethernet hardware address.
        field source: bytes(6) as super::address::MacAddress;
        /// The Ethernet protocol type.
        field ether_type: BeU16 as super::ether_type::EtherType;
