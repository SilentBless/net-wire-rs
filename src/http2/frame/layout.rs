...
wire_repr::wire_repr! {
    ...
    pub(in crate::http2) layout Http2FrameLayout {
        ...
        payload_length_high: U8;
        /// Middle payload-length octet.
        payload_length_middle: U8;
        /// Low payload-length octet.
        payload_length_low: U8;
        /// Raw frame type.
        frame_type: U8 as super::super::types::Http2FrameType;
        /// Raw frame flags.
        flags: U8;
        /// Raw stream identifier, including its reserved bit.
        stream_id: BeU32 as super::super::types::Http2StreamId;
